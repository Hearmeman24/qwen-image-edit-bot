...
RUN aria2c -x 16 -s 16 -k 1M -d /models/diffusion_models -o qwen_image_edit_bf16.safetensors \
...
RUN aria2c -x 16 -s 16 -k 1M -d /models/text_encoders -o qwen_2.5_vl_7b.safetensors \
https://huggingface.co/Comfy-Org/Qwen-Image_ComfyUI/resolve/main/split_files/text_encoders/qwen_2.5_vl_7b.safetensors

RUN aria2c -x 16 -s 16 -k 1M -d /models/vae -o qwen_image_vae.safetensors \
https://huggingface.co/Comfy-Org/Qwen-Image_ComfyUI/resolve/main/split_files/vae/qwen_image_vae.safetensors

RUN aria2c -x 16 -s 16 -k 1M -d /models/loras -o Qwen-Image-Lightning-8steps-V1.1.safetensors \
